...
\node at (\marginLR+2,-3cm)                           [below right, yshift=4cm, xshift=\decalmu] {$\phi\push\mu$};
...
% p
\draw [->] (\mushiftx+1cm+\decalmu,  \mushifty+0.4cm) -- (\mushiftx+1cm+\decalmu,  \mushifty-3cm) node[midway,right] {$\phi$};
